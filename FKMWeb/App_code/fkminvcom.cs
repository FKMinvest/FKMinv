...
public class fkminvcom
{
   //SqlConnection fkmconn = new SqlConnection("Data Source=.\\SQLEXPRESS;AttachDbFilename=C:\\src\\FKMWeb\\App_Data\\FKMINVDB.mdf;Integrated Security=True;Connect Timeout=120;User Instance=True");
    SqlConnection fkmconn = new SqlConnection("Data Source=LUISFRANCISCO\\SQLEXPRESS;Initial Catalog=FKMINVDB;Integrated Security=True");
 //  Data Source=LUISFRANCISCO\SQLEXPRESS;Initial Catalog=FKMINVDB;Integrated Security=True;User Instance=True

   // Data Source=LUISFRANCISCO\FKMWEB;Initial Catalog=FKMINVDB;Integrated Security=True
        public fkminvcom()
    {
        //
    ...
    public DataTable SelTable(string sqlstring)
    {
        DataTable dt = new DataTable();
        SqlDataAdapter da = new SqlDataAdapter();
        try
        {
            ErrorLog(sqlstring, "C:\\src\\FKMWeb\\Logs\\SQLQuery");
            da.SelectCommand = new SqlCommand(sqlstring, fkmconn);
            da.Fill(dt);
        }
        catch (Exception err)
        {
    ...
    public bool InsRecord(string sqlstring) // As DataTable\
    {
        return UpdTable(sqlstring);
    }

    public bool DelRecord(string sqlstring) // As DataTable\
    {
        return UpdTable(sqlstring);
    }

    public bool UpdTable(string Sqlstring) // As DataTable\
    {
    ...
    public bool RecExist(string sqlstring)
    {
        DataTable dt = new DataTable();
        SqlDataAdapter da = new SqlDataAdapter();
    ...
    public bool Transact(string str1, string str2, string str3, string str4, string str5)
    {
        ...
        SqlCommand cmd5 = new SqlCommand(str5);
        ...
        try
        {
            ...
            ErrorLog(str1, "C:\\src\\FKMWeb\\Logs\\SQLQuery");
            cmd1.Transaction = tran;
            cmd1.ExecuteNonQuery();
            if (str2.Length > 0)
            {
                ErrorLog(str2, "C:\\src\\FKMWeb\\Logs\\SQLQuery");
                cmd2.Transaction = tran;
                cmd2.ExecuteNonQuery();
            }
            if (str3.Length > 0)
            {
                ErrorLog(str3, "C:\\src\\FKMWeb\\Logs\\SQLQuery");
                cmd3.Transaction = tran;
                cmd3.ExecuteNonQuery();
            }
            if (str4.Length > 0)
            {
                ErrorLog(str4, "C:\\src\\FKMWeb\\Logs\\SQLQuery");
                cmd4.Transaction = tran;
                cmd4.ExecuteNonQuery();
            }
            if (str5.Length > 0)
            {
                ErrorLog(str5, "C:\\src\\FKMWeb\\Logs\\SQLQuery");
