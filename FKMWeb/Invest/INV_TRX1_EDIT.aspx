<%@ Page Title="INVESTMENT TRANSACTIONS (JADE)" Language="C#" MasterPageFile="~/MainPage.Master"
    AutoEventWireup="false" CodeFile="INV_TRX1_EDIT.aspx.cs" Inherits="INVEST_TRX1_EDIT" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <table>
        <tr>
                ...
                <table   >
                    <tr>
                        ...
                        <td class="style1">
                            <cc1:ComboBox ID="CMB_FKM_CD" runat="server" DataTextField="FKM_PROJNAME" DataValueField="FKM_SRL"
                                ...
                                AutoCompleteMode="SuggestAppend" Width="100px" AutoPostBack="true">
                            </cc1:ComboBox>
                        </td>
                        <td>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style1">
                            ...
                            <cc1:ComboBox ID="CMB_REFSRL" runat="server" DropDownStyle="DropDownList"  
                                  AutoCompleteMode="SuggestAppend" Width="200px" AutoPostBack="True"
                                DataSourceID="SqlDataSource2" DataTextField="TRX_REFSRL" DataValueField="TRX_REFSRL"
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:FKMCONNSTR %>"
                                SelectCommand="SELECT DISTINCT [TRX_REFSRL] FROM [INVEST_TRX1] WHERE ([TRX_FKM_SRL] = @TRX_FKM_SRL) ORDER BY [TRX_REFSRL] DESC">
                                <SelectParameters>
                    ...
                    <tr>
                        ...
                        <td valign="top"  rowspan="17" colspan="5">                            
                           <div style="overflow-x: auto; overflow-y: auto; height: 400px; width: 1150px;">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="TRX_REFSRL"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TRX_REFSRL" HeaderText="REFERENCE" />
                                        <asp:BoundField DataField="TRX_ISSUEDATE" HeaderText="DATE" SortExpression="TRX_ISSUEDATE" />
                                        <asp:BoundField DataField="TRX_INVAMT_R" HeaderText="INVESTMENT AMOUNT" ItemStyle-HorizontalAlign="Right" />
            ...
            SelectCommand="SELECT [TRX_REFSRL],[TRX_REFMEMO], [TRX_ISSUEDATE], [TRX_INVAMT],[TRX_AMT], [TRX_ROI], [TRX_REMX],[TRX_UPDBY] FROM [INVEST_TRX] WHERE ([TRX_FKM_SRL] = @TRX_FKM_SRL)">
            <SelectParameters>
                <asp:ControlParameter ControlID="CMB_FKM_CD" DefaultValue="#" 
                    Name="TRX_FKM_SRL" PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>--%>
                            </div>
                        </td>
             ...
             <asp:RegularExpressionValidator ID="RegularExpressionValidator11" ControlToValidate="TXT_INCOME" 
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator11" ControlToValidate="TXT_INCOME"
                    ...
                    <tr>
                        ...
                        <td class="style1">
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator12" ControlToValidate="TXT_TROI"
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator13" ControlToValidate="TXT_TOTSNCINCP"
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="LBL_TRX_CAPRTRN" runat="server" Text="RETURN OF CAPITAL"></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:TextBox ID="TXT_TRX_CAPRTRN" runat="server" Width="200px" onchange="numformat(this)"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LBL_TRX_CAPGN" runat="server" Text="CAPITAL GAIN"></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:TextBox ID="TXT_TRX_CAPGN" runat="server" Width="200px" onchange="numformat(this)"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LBL_TRX_DVDND" runat="server" Text="DIVIDEND"></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:TextBox ID="TXT_TRX_DVDND" runat="server" Width="200px" onchange="numformat(this)"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LBL_TRX_INT_ADDL" runat="server" Text="INTEREST BY ADDITIONAL"></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:TextBox ID="TXT_TRX_INT_ADDL" runat="server" Width="200px" onchange="numformat(this)"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LBL_TRX_BNKCHRG" runat="server" Text="BANK CHARGES"></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:TextBox ID="TXT_TRX_BNKCHRG" runat="server" Width="200px" onchange="numformat(this)"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LBL_TRX_TRSFERKW" runat="server" Text="TRANSFER FROM KUWAIT"></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:TextBox ID="TXT_TRX_TRSFERKW" runat="server" Width="200px" onchange="numformat(this)"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LBL_TRX_FEES" runat="server" Text="FEES"></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:TextBox ID="TXT_TRX_FEES" runat="server" Width="200px" onchange="numformat(this)"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LBL_BANKCD" runat="server" Text="BANK NAME"></asp:Label>
                        </td>
                        <td>
                            <cc1:ComboBox ID="CMB_TRX_BANKCD" runat="server" DataTextField="BNK_NAME" DataValueField="BNK_REFSRL"
